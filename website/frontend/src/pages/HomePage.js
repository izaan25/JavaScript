...
export default function HomePage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      getDocuments({ limit: 100, fileType: 'javascript', ungrouped: true }),
    ]).then(([s, c, r, p]) => {
      setCategories(c.data);
      setRecent(r.data.documents);
      setJsFiles(p.data.documents);
  ...
  return (
    <div>
      ...
      <section className="hero fade-up">
        ...
        <p>
          I provide a curated collection of JavaScript algorithms, data structures, 
          and technical documentation designed for modern web engineers.
        </p>
      ...
      <section style={{ marginBottom: '80px' }}>
        ...
        <div className="grid grid-bento">
          ...
          {jsFiles.map(doc => <DocCard key={doc.path} doc={doc} />)}
        </div>
      </section>
